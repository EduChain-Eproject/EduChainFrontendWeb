...
class BlogCateRepositoryImpl implements BlogCateRepository {
    async getCates(): Promise<{ data?: BlogCategory[]; error?: string }> {
        try {
    ...
    async getCate(cateId: number): Promise<{ data?: BlogCategory; error?: string }> {
        try {
    ...
    async createCate(cateData: CreateCateReq): Promise<{ data?: BlogCategory; error?: string }> {
        try {
    ...
    async updateCate(cateId: number, cateData: UpdateCateReq): Promise<{ data?: BlogCategory; error?: string }> {
        try {
