...
export const createCate = createAsyncThunk(
  'blog_category/createCate',
  async (cateData: CreateCateReq) => {
...
export const updateCate = createAsyncThunk(
  'blog_category/updateCate',
  async ({ cateId, cateData }: { cateId: number; cateData: UpdateCateReq }) => {
...
export const resetCreateCateAction = createAction(
  'blog_category/resetCreateCateAction',
);
