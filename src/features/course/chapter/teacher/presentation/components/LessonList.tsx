...
import { lessonDeleted } from '../redux/courseSlice';
...
const LessonList: React.FC<LessonListProps> = ({ lessons, onLessonClick, onUpdateLesson, onDeleteLesson, onCreateClick }) => {
    const dispatch = useDispatch()
    const { data: deletedLessonId } = useAppSelector(state => state.lessons.teacher.deleteLessonPage)
    ...
    return (
        <div className="mt-4">
            <div className='flex flex-row justify-between'>
                ...
                <button className='p-3 rounded-xl bg-meta-5 hover:bg-meta-3 text-white'
