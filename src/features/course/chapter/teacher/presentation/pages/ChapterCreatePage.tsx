...
const ChapterCreatePage: React.FC = () => {
  ...
  const { status, error } = useAppSelector(
    (state) => state.chapters.teacher.createChapterPage,
  );
  ...
  const breadCrumbItems = [
    ...
    {
      label: `Course ${courseData?.title}`,
      href: `/dashboard/teacher/courses/${courseData?.id}`,
    },
    {
      label: `Create chapter`,
      href: `/dashboard/teacher/courses/${courseId}/chapters/create`,
    },
  ];
