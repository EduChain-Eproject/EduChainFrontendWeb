...
import {
  CourseStatusForCensor,
  fetchCoursesByStatus,
  GetCoursesByStatusRequest,
} from '../../data/services/handleGetCourseByStatus';
...
const breadCrumbItems = [
  {
    label: 'Home',
    href: '/dashboard/censor',
  },
  {
    label: 'List of Courses',
    href: '/dashboard/censor/courses',
  },
];
...
const CoursesPage: React.FC = () => {
  ...
  const { data, status, error } = useAppSelector(
    (state) => state.courses.censor.listCoursesPage,
  );
  ...
  const [selectedStatus, setSelectedStatus] = useState<CourseStatusForCensor>(
    CourseStatusForCensor.ALL,
  ); // Default to APPROVED
